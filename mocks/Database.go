...
// UpdatePerson provides a mock function with given fields: id, updates
func (_m *Database) UpdatePerson(id uint, updates map[string]interface{}) error {
...
func (_e *Database_Expecter) UpdatePerson(id interface{}, updates interface{}) *Database_UpdatePerson_Call {
	return &Database_UpdatePerson_Call{Call: _e.mock.On("UpdatePerson", id, updates)}
}

func (_c *Database_UpdatePerson_Call) Run(run func(id uint, updates map[string]interface{})) *Database_UpdatePerson_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(uint), args[1].(map[string]interface{}))
	})
	return _c
...
func (_c *Database_UpdatePerson_Call) Return(_a0 error) *Database_UpdatePerson_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Database_UpdatePerson_Call) RunAndReturn(run func(uint, map[string]interface{}) error) *Database_UpdatePerson_Call {
	_c.Call.Return(run)
	return _c
}
