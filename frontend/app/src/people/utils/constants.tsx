import { aboutSchema, postSchema, wantedSchema, meSchema, offerSchema, wantedCodingTaskSchema, wantedItemSchema } from "../../form/schema";
...
export { MAX_UPLOAD_SIZE, widgetConfigs, formDrowdownOptions }