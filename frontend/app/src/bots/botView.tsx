...
export default function BotView(props: any) {
    ...
    let bot: any =
        main.bots &&
        main.bots.length &&
        main.bots.find((f) => f.unique_name === botUniqueName)
    ...
    // FOR BOT VIEW
    let bots: any =
        main.bots && main.bots.length && main.bots.filter((f) => !f.hide)
    ...
    return (
        <Content>{isMobile ? renderMobileView() : renderDesktopView()}</Content>
    )
}
