...
export default function BotBody() {
    ...
    function selectBot(attr: string) {
        ...
        if (isMyBots) {
            ...
            const thisBot = botSource.find(
                (f) => f[botSelectionAttribute] === attr
            )
    ...
    function redirect() {
        ...
        el.target = '_blank'
        el.href =
            'https://github.com/stakwork/sphinx-relay/blob/master/docs/deep/bots.md'
        el.click()
    }
                ...
                >
                    {!ui.meInfo && (
                        <div style={{ marginTop: 50 }}>
                            <NoneSpace
                                ...
                                sub={
                                    'Spice up your Sphinx experience with our diverse range of Sphinx bots'
                                }
                                style={{ height: 400 }}
                            />
                            <Divider />
                    ...
                    >
                        <BotView
                            ...
                            loading={loading}
                            selectBot={(b) =>
                                selectBot(b[botSelectionAttribute])
                            }
                            botView={true}
                        />
                    </FadeLeft>
                ...
                <div style={{ overflowY: 'auto' }}>
                    ...
                    >
                        ...
                        >
                            ...
                            <BotText>
                                Share your awesome bot with other Sphinx chat
                                users!
                            </BotText>
                            <Button
                                text={'Add a Bot'}
