...
import { BountyMetrics, MockHunterMetrics } from 'store/main';
      ...
      <Wrapper ref={freezeHeaderRef}>
        <Card>
          <UpperCardWrapper>
            ...
            <StatusWrapper>
              <Subheading marginTop="5px" marginLeft="0px">Completed</Subheading>
          ...
          <BelowCardWrapper>
            <DivWrapper>
              <div>
                ...
                <Subheading width="80px" data-testid="total_bounties_posted">Total Posted</Subheading>
              </div>
              <VerticaGrayLine />
            </DivWrapper>
            <DivWrapper>
        ...
        <CardGreen>
          <UpperCardWrapper>
            ...
            <StatusWrapper>
              <Subheading marginTop="5px" marginLeft="0px" data-testid="total_satoshis_paid">Paid</Subheading>
