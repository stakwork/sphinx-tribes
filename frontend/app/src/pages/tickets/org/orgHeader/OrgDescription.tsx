...
function OrgDescription({ updateIsPostBountyModalOpen, orgData }: { updateIsPostBountyModalOpen: (value: boolean) => void, orgData:Organization|undefined }) {
     ...
     <Leftheader>
      ...
      <CompanyContainer>
        <CompanyLabel>{name || ""}</CompanyLabel>
          <ButtonContainer>
                <SmallButton href={website} target="_blank"><img src={Globe} alt="globe-website icon"/>Website</SmallButton>
                <SmallButton href={github} target="_blank"> <img src={GithubIcon} alt="github icon"/>Github</SmallButton>
          </ButtonContainer>
      </CompanyContainer>
