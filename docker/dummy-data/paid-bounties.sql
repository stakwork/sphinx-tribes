...
(
    ...
    NOW() - INTERVAL '14 days', 
    NOW() - INTERVAL '13 days', 
    ARRAY['JavaScript', 'CSS', 'HTML'], '', 3, false, false
),
...
(
    ...
    NOW() - INTERVAL '9 days', 
    NOW() - INTERVAL '8 days', 
    ARRAY['CSS', 'JavaScript', 'React'], '', 2, false, false
),
...
(
    ...
    NOW() - INTERVAL '6 days', 
    NOW() - INTERVAL '5 days', 
    ARRAY['Python', 'TensorFlow', 'SQL'], '', 1, false, false
),
...
(
    ...
    NOW() - INTERVAL '5 days', 
    NOW() - INTERVAL '4 days', 
    ARRAY['Go', 'React', 'SQL'], '', 2, false, false
),
...
(
    ...
    NOW() - INTERVAL '12 hours', 
    NOW() - INTERVAL '6 hours', 
    ARRAY['HTML', 'CSS', 'JavaScript'], '', 2, false, false
);
...
(
    ...
    NOW() - INTERVAL '15 days', 
    NOW() - INTERVAL '14 days', 
    ARRAY['Go', 'JavaScript'], '', 2, false, false
);
...
(
    ...
    NOW() - INTERVAL '10 days', 
    NOW() - INTERVAL '9 days', 
    ARRAY['JavaScript', 'HTML', 'CSS'], '', 2, false, false
);
...
(
    ...
    NOW() - INTERVAL '7 days', 
    NOW() - INTERVAL '6 days', 
    ARRAY['Rust', 'Rocket', 'YAML'], '', 1, false, false
);